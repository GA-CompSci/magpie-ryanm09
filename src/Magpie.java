...
public class Magpie {
	...
	public String getResponse(String statement){
		...
		//--I LIKE SOMETHING--
			...
			int likePos = findKeyword(statement, "I like");
			//cut the substring of the thing you like
			
			String like = statement.substring(likePos + "I like".length()).trim();

			response = "Why do you like " + like + "?";
		}

		// -- I WANT SOMETHING -- 
		else if(findKeyword(statement, "I want") != -1){
			//Locate the "I want" phrase
			int wantPos = findKeyword(statement, "I want");
			//chop off the stuff after "I want"
			String want = statement.substring(wantPos + "I want".length()).trim();

			response = "Why do you want " + want + "?";
		}
